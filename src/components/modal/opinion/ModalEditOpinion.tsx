...
export function ModalEditOpinion({
  baseInfo,
  modalEditRowIsOpen,
  handleUpdateListing,
  ...
  async function handleSubmitForm(dataForm: any) {
    ...
    if (fileImageSelect) {
      ...
      imageData.append('imageOpinion', fileImageSelect)

      const responseUpload = await uploadViewModel.uploadImageOpinion(imageData)
    ...
    const response = await opinionViewModel.updateOpinionData(
        ...
        <div className="w-full h-full flex items-center justify-center ">
          ...
          <div className="w-full h-auto max-h-[90%] max-w-3xl flex flex-col items-center p-0  rounded-md overflow-y-auto bg-dark overflow-x-hidden scroll-smooth">
            <div className="w-full py-4 px-5 flex flex-row justify-between items-center border-b-[1px] border-gray-600 ">
              <p className="text-xl font-medium text-light">Editar opinion</p>
