...
import { TableRow } from '../../components/table/TableRowDownloadPermissions'
import { SelectCustom } from '../../components/selects/SelectCustom'
import { ModalCreateDownloadPermission } from '../../components/modal/downloadPermission/ModalCreateDownloadPermission'
import { ModalEditDownloadPermission } from '../../components/modal/downloadPermission/ModalEditeDownloadPermission'
import { IDownloadPermission } from '../../interfaces/downloadPermission'
...
function DownloadPermissions() {
  ...
  const itemsBreadcrumbs = [
    ...
    { label: 'Permissão para download', to: routsNameMain.admins },
    { label: 'Listagem' }
  ]
  const tableData: IDownloadPermission[] = [
    {
      id: 1,
      email: 'exemple@gmail.com',
      type_permission: 'diary',
      time_permission: 1,
    ...
    <div className="w-full h-full flex flex-col justify-start items-start gap-6">
      <div className="w-full p-6 flex flex-col justify-start items-start gap-6 rounded-md bg-light dark:bg-dark">
        ...
        <h1 className="text-2xl font-bold text-dark dark:text-light ">
          Permissão para baixar o jornal
        </h1>
