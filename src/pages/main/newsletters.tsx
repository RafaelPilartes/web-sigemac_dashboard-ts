...
import { TableRow } from '../../components/table/TableRowNewsletter'
import { SelectCustom } from '../../components/selects/SelectCustom'
import { ModalCreateNewsletter } from '../../components/modal/newsletter/ModalCreateNewsletter'
import { ModalEditNewsletter } from '../../components/modal/newsletter/ModalEditeNewsletter'
...
function Newsletters() {
  ...
  const itemsBreadcrumbs = [
    ...
    { label: 'Newsletter', to: routsNameMain.admins },
    { label: 'Listagem' }
  ]
  const tableData: INewsletter[] = [
    {
      id: 1,
