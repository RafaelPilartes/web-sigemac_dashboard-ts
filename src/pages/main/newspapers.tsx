...
import { TableRow } from '../../components/table/TableRowNewspaper'
import { SelectCustom } from '../../components/selects/SelectCustom'
import { ModalEditNewspaper } from '../../components/modal/newspaper/ModalEditNewspaper'
import { ModalCreateNewspaper } from '../../components/modal/newspaper/ModalCreateNewspaper'
...
function Newspapers() {
  ...
  const itemsBreadcrumbs = [
    ...
    { label: 'Jornais', to: routsNameMain.newspapers },
    { label: 'Listagem' }
  ]
  const tableData: INewspaper[] = [
    {
      id: 1,
      link_newsPaper: 'https://www.exemplo.com/jornal1',
      cover_newsPaper: 'capa_jornal1.jpg',
      name_newsPaper: 'Jornal 1',
      description_newsPaper: 'Descrição do Jornal 1',
      date_newsPaper: '2023-10-13',
      date_create: '2023-10-13'
    },
    {
      id: 2,
      link_newsPaper: 'https://www.exemplo.com/jornal2',
      cover_newsPaper: 'capa_jornal2.jpg',
      name_newsPaper: 'Jornal 2',
      description_newsPaper: 'Descrição do Jornal 2',
      date_newsPaper: '2023-10-14',
