...
import { TableRow } from '../../components/table/TableRowAdvertising'
import { SelectCustom } from '../../components/selects/SelectCustom'
import { ModalEditAdvertising } from '../../components/modal/advertising/ModalEditAdvertising'
import { ModalCreateAdvertising } from '../../components/modal/advertising/ModalCreateAdvertising'
...
function Advertising() {
  ...
  const itemsBreadcrumbs = [
    ...
    { label: 'Publicidades', to: routsNameMain.admins },
    { label: 'Listagem' }
  ]
  const tableData = [
    {
      id: 1,
      image_publicity: 'imagem_publicidade1.jpg',
      description_publicity: 'Descrição da Publicidade 1',
      link_publicity: 'https://www.example.com/publicidade1',
      local_publicity: 'Local da Publicidade 1',
      date_create: '2023-10-13',
      date_expire: '2023-11-13'
    },
    {
      id: 2,
      image_publicity: 'imagem_publicidade2.jpg',
      description_publicity: 'Descrição da Publicidade 2',
      link_publicity: 'https://www.example.com/publicidade2',
      local_publicity: 'Local da Publicidade 2',
      date_create: '2023-10-14',
      date_expire: '2023-11-14'
    }
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-sm font-thin bg-gray-300/40 dark:bg-gray-500/40 ">
              <tr className="border-b dark:border-gray-700">
                ...
                <th
                  scope="col"
                  className="px-3 py-3 min-w-[6rem] line-clamp-1 "
                >
                  Link
                </th>
                <th scope="col" className="px-3 py-3 min-w-[6rem] ">
